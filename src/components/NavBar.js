            ...
            <Container>
              ...
              <Navbar.Collapse id="responsive-navbar-nav">
                <Nav className='ms-auto navbar-navbar'>
                  <Nav.Link className="nav-a" as={Link} to="/">Home<FaAngleDown className="down-arrow-icon" />
                  ...
                  <Nav.Link className="nav-a" href="#deets">About <FaAngleDown className="down-arrow-icon" />
                  ...
                  <Nav.Link className="nav-a" href="#deets">Pages<FaAngleDown className="down-arrow-icon" />
                    <div className='dropdown-content'>
                  ...
                  <Nav.Link className="nav-a" href="#deets">Shop <FaAngleDown className="down-arrow-icon" />
                    <div className='dropdown-content'>
                      <Nav.Link href="./">Shop</Nav.Link>
                      <Nav.Link href="#deets">Checkout</Nav.Link>
                    </div>
                  </Nav.Link>
                  <Nav.Link className="nav-a" href="#deets">Blog <FaAngleDown className="down-arrow-icon" />
                    <div className='dropdown-content'>
              ...
              <Nav className='option'>
                <a className="shopcart-btn" href="#deets">< MdOutlineShoppingCart /><span className='shopcart-num'>0</span></a>
                <a className="btn supportbtn" href="#memes">Support</a>
                <a className='btn loginbtn' href="#memes">Login</a>
              </Nav>
            </Container>
          </Navbar>
          <Routes>
